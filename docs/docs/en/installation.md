...
We have created a script that handles all the "dirty work" for you: checks your system, installs dependencies (apt), creates the virtual environment (venv), and sets up credentials.
...
To use "Text Refinement" features (LLM rewriting), you need a Google Gemini API Key.
