...
El backend daemon y sus clientes se comunican exclusivamente a través de un **Socket Unix**, utilizando un protocolo binario/JSON personalizado optimizado para baja latencia y seguridad local.
